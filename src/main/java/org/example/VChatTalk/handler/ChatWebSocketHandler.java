...
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        welcomeMessage.setContent("Welcome! You are connected to the chat server.");
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
        ...
        log.info("Session disconnected: [{}] with status {}. Total sessions: {}",
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        try {
            ...
            if (roomIdAttr != null) {
                dto.setRoomId(roomIdAttr.toString());
            }
        }
        ...
        MessageDTO echoMessage = new MessageDTO();
        echoMessage.setSender("System");
        echoMessage.setContent("Echo: " + dto.getContent());
        echoMessage.setTimestamp(Instant.now());

        String echoJson = objectMapper.writeValueAsString(echoMessage);
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    ...
                    iterator.remove();
                    log.warn("[CLEANUP] Removed dead session {} due to IOException", s.getId());
                }
            }
